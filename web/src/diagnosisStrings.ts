// What the leaf model can say, in words a grower acts on. Same wording as the
// phone app (src/i18n/diagnosis-strings.ts); the server sends codes. Merged
// into each language table in i18n.tsx.
...
export const diagnosisStrings = { en, tr };
